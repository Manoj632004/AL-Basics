...
codeunit 50354 "Excel Helper"
{
    Access = Internal;
    SingleInstance = true;

    procedure ExportAllUserRecordsToExcel(ExcelExportLocation: Enum "Excel Exort Location")
    var
        TempExcelBuffer: Record "Excel Buffer" temporary;
    begin
        CreateExcelHeaders(TempExcelBuffer);
        ExportAllUserRecordsToExcel(TempExcelBuffer);
        CloseExcelFile(ExcelExportLocation, 'Users', TempExcelBuffer);
    end;
    ...
    local procedure CloseExcelFile(ExcelExportLocation: Enum "Excel Exort Location"; Name: Text[250]; var TempExcelBuffer: Record "Excel Buffer" temporary)
    var
        IExcelExportLocation: Interface "ExcelHelper";
        FileNameWithExtensionTok: Label 'Business Central Booster %1.xlsx';
        FileName: Text;
    begin
        IExcelExportLocation := ExcelExportLocation;
        ...
        IExcelExportLocation.Export(FileName, TempExcelBuffer);
    end;
